/**
 * Main application entry point that starts the JavaFX user interface.
 */
...
public class ClientApplication extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            primaryStage.setScene(new Scene(root, AppConstants.LOGIN_WIDTH, AppConstants.LOGIN_HEIGHT));            primaryStage.setResizable(false);
            primaryStage.show();
        } catch (IOException e) {
