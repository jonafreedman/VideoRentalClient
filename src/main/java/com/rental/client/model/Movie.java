...
public class Movie {
    ...
    /**
     * Constructs a new Movie object for creation payloads (without ID).
     *
     * @param title movie title
     * @param category genre category
     * @param copies total initial physical inventory allocation
     */
    public Movie(String title, String category, int copies) {
        this.title = title;
